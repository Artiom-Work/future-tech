...
class Select extends BaseComponent {
	...
	updateUI() {
		const {
			isExpanded, currentOptionIndex, selectedOptionElement
		} = this.state
	...
	selectCurrenOption() {
		this.state.selectCurrenOption = this.optionElements[this.state.currentOptionIndex]
	}
	...
	bindEvents() {
		...
		this.originalControlElement.addEventListener('change', this.onOriginalControlChenge)
	}
}
